...
describe('Test API contact', function () {
  ...
  it('Test with an invalid email length, should return status 400 with message : Invalid email', function (done) {
    chai
      .request(host)
      .post('/api/contact')
      .type('form')
  ...
  it('Test with an invalid name, should return status 400 with message : Invalid name', function (done) {
    chai
      .request(host)
      .post('/api/contact')
      .type('form')
