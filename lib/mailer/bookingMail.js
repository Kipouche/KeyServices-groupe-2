/**
 * Email d'information sur les dates de location
 * À envoyer quand un bien est renseigné comme étant loué
 *
 * @param {*} startDate date de début de la location
 * @param {*} endDate date de fin de la location
 * @param {*} firstname prénom du propriétaire
 */
const bookingMail = (startDate, endDate, firstname) => {
  const host =
  ...
  body {font-family: 'Muli', sans-serif;}
    ...
    <![endif]-->
      ...
      <tbody>
        <tr>
          <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">${firstname}, <br/>il y a du nouveau &nbsp;</span></div><div></div></div></td>
        </tr>
      </tbody>
    </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
      <tbody>
        <tr>
          <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Votre bien vient d'être reservé du ${startDate} au ${endDate}</span></div>
  </div></td>
        </tr>
      </tbody>
    ...
    <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe" style="color:#444444; font-size:12px; line-height:20px; padding:16px 16px 16px 16px; text-align:Center;" data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5">
      ...
      `,
    text: `Il y a du nouveau, ${firstname}! \n
      Votre bien est reservé du ${startDate} au ${endDate}.\n
      \nÀ bientôt
