const confirmMail = (id, token, firstname) => {
  const host =
    process.env.NODE_ENV !== 'development'
      ? 'https://f2i-dev18-km-jl-js-gg.herokuapp.com/'
      : 'http://localhost:5000';
  return {
    html: `
...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="95" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://f2i-dev18-km-jl-js-gg.herokuapp.com/logo.png" height="33">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Nous vous remercions pour votre inscription, ${firstname}!&nbsp;</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Merci de confirmer votre adresse mail</span><span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> afin que nous soyons sûrs que vous êtes bien vous</span><span style="font-size: 18px">.</span></div>
<div style="font-family: inherit; text-align: center"><span style="color: #71CDB1; font-size: 18px"><strong>Merci!&nbsp;</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
        ...
        <tr>
          <td align="center" bgcolor="#ffffff" class="outer-td" style="padding:0px 0px 0px 0px;">
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
              <tbody>
                <tr>
                <td align="center" bgcolor="#71CDB1" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a href="${host}/api/auth/confirm?id=${id}&token=${token}" style="background-color:#71CDB1; border:1px solid #71CDB1; border-color:#71CDB1; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Confirmer l'Email</a>
                </td>
                </tr>
              </tbody>
            </table>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 50px 30px; line-height:22px; text-align:inherit; background-color:#071D34;" height="100%" valign="top" bgcolor="#6e6e6e" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px"><strong>Que se passe t-il ensuite :</strong></span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">1. Vous pourrez mettre votre bien en ligne.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">2. Prendre rendez-vous avec un de nos conseillers.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">3. Gérer vos locations depuis votre espace client.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">4. Profiter du temps que vous allez gagner.</span></div>

<div style="font-family: inherit; text-align: center"><span style="color: #71CDB1; font-size: 18px"><strong>et bien plus encore!</strong></span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">Besoin d'aide? Notre équipe est</span></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">toujours prête à aider!&nbsp;</span></div><div></div></div></td>
      </tr>
    </tbody>
      ...
      <tbody>
        <tr>
          <td align="center" bgcolor="#071D34" class="outer-td" style="padding:0px 0px 0px 0px;">
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
              <tbody>
                <tr>
                <td align="center" bgcolor="#71CDB1" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a href="${host}/contact" style="background-color:#71CDB1; border:1px solid #71CDB1; border-color:#71CDB1; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;">Contacter le Support</a>
                </td>
                </tr>
              </tbody>
            </table>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="071D34">
        </td>
      </tr>
    </tbody>
  </table></td>
  ...
  <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe" style="color:#444444; font-size:12px; line-height:20px; padding:16px 16px 16px 16px; text-align:Center;" data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5">
    <div class="Unsubscribe--addressLine">
      <p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">KeyServices</p><p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">keyserviceshosting@gmail.com</span>, <span class="Unsubscribe--senderCity">Paris</span>, <span class="Unsubscribe--senderState">France</span></p></div>
    ...
    `,
    text: `Nous vous remercions pour votre inscription, ${firstname}! \n
    Pour des raisons de sécurités, merci de confirmer votre Email en cliquant sur le lien suivant.\n
    \n ${host}/api/auth/confirm?id=${id}&token=${token}
    \nÀ bientôt
    \n  L'équipe KeyServices`
  };
};
