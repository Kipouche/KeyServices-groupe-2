const confirmMail = (id, token, firstname) => {
  const host =
    process.env.NODE_ENV !== 'development'
      ...
      const confirmUrl = `${host}/api/auth/confirm?id=${id}&token=${token}`
      console.log(`${host}/api/auth/confirm?id=${id}&token=${token}`);
...
<div style="font-family: inherit; text-align: center"><span style="color: #71CDB1; font-size: 18px"><strong>Thank you!&nbsp;</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 50px 30px; line-height:22px; text-align:inherit; background-color:#071D34;" height="100%" valign="top" bgcolor="#6e6e6e" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px"><strong>Here’s what happens next:</strong></span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">1. Put your rental online.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">2. Wait for your rental to be approved by ours dedicated agents. We'll take care of it.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">3. Profit !</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">4. Or, you can also explore the rentals that are available and book one of them.</span></div>

<div style="font-family: inherit; text-align: center"><span style="color: #71CDB1; font-size: 18px"><strong>+ much more!</strong></span></div>
<div style="font-family: inherit; text-align: center"><br></div>
...
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">ready to help!&nbsp;</span></div><div></div></div></td>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="071D34">
                                            ...
                                            <div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">KeyServices</p><p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">keyserviceshosting@gmail.com</span>, <span class="Unsubscribe--senderCity">Paris</span>, <span class="Unsubscribe--senderState">France</span> <span class="Unsubscribe--senderZip">{{Sender_Zip}}</span></p></div>
    ...
    Please verify your email address to get access to thousands of hostings.
    Thank you! \n
    We now need you to confirm your registration by clicking on the link below
    \nVerify you email now by cliking on this link: ${host}/api/auth/confirm?id=${id}&token=${token}
    \nSee you soon, the KeyServices team`
  };
};
